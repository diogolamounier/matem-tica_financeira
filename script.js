function generateQuestion() {
    ...
    switch (topic) {
        case 0: // Simple Interest
            let questionTextSI = `Se você investir $${principal} a uma taxa de  ${rate}% por ${time} anos, quanto você ganhará em juros simples?`;
        ...
        case 1: // Compound Interest
            let questionTextCI = `Se você investir $${principal} a uma taxa de ${rate}% por ${time} anos, capitalizada ${compoundingFrequency} vezes ao ano, quanto você terá ao todo?`;
